...
<header>
    <div class="wrapper">
    <p>Witaj w bazie danych regionów z gry X</p>
    </div>
</header>
    <main>
    <?php
...
mysqli_query($conn,'SET NAMES utf8');
    ...
    $result=mysqli_query($conn,"SELECT * FROM regiony1");
?>
<div class="wrapper">
<?php
   echo '<table border=1>';
   ...
   while($row=mysqli_fetch_array($result))
   {
       ...
       echo "<td>".$row['klimat']."</td>";
       echo "<td>".$row['trudność']."</td>";
       echo "<td>".$row['język']."</td>";
       echo "</tr>";
}
   echo '</table>';
?>
